...
const [formValues, handleInputChange, , reset, setFormValues] =
  ...
  useEffect(() => {
    const getConfederation = async () => {
      const confederation = await getConfedById(id)
      setFormValues(prev => ({
        ...prev,
        ConfedName: confederation.confed_name,
        ConfedAbrev: confederation.confed_3,
        Url: confederation.img_url
      }))
    }
    getConfederation()
  }, [])
