...
export const CustomJob = () => {
    ...
    useEffect(() =>{
      file && edgestore.publicFiles.upload({
        file
  ...
  return (
    <form className='flex flex-col gap-6 p-8 w-[600px]' onSubmit={handleSubmit}>
      <label
        htmlFor='email'
      ...
      >
        <span className='flex gap-3'>
          Real image
          <span className='underline'>*Put a real image or video of the scoreboard</span>
        </span>
        <input
          type='file'
          name='image'
